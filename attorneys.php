		...
		We have the team of experts and they are ready to<br> help you anytime and anywhere.	</span>
            ...
            <a href="#">
			   ...
			   class="social-icon soc-google "  target="_blank"></a>
                                                                ...
                                                                <!-- eof social icons -->
                                                                <div class="desc">
                                                                    <p>"I have worked with Tipatone for over 2 years and the efficeincy of their work on digital is amazing, they brought innovative and creative ways to help my company have a great foot hold in the digital sphere"</p>
                                                                </div>
            ...
            <a href="#">
			   ...
			   class="social-icon soc-google "  target="_blank"></a>
                                                                ...
                                                                <!-- eof social icons -->
                                                                <div class="desc">
                                                                    <p>"As we were starting out we consulted Tipatone for their Services and their work gave us the boost we needed to reach our customers, gave us the Training on the digital marketing and since then things have never been better"
                                                                    </p>
                                                                </div>
                                                            <!--    <div class="item-button topmargin_30">
            ...
            <a href="#">
			   ...
			   class="social-icon soc-google "  target="_blank"></a>
                                                                ...
                                                                <!-- eof social icons -->
                                                                <div class="desc">
                                                                    <p>"Creative and Proactive is what can be used to describe Tipatone"
                                                                    </p>
                                                                </div>
                                                               <!-- <div class="item-button topmargin_30">
