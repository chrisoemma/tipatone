	...
	<span class="highlight regular text-transform-none ">
		...
		Due to our long time experience in many areas we will help you to find the best solution on any issue.	</span>
                                            ...
                                            <div class="form-wrapper  columns_padding_15 text-left dark_bg">
                                                <form data-fw-form-id="fw_form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" class="fw_form_fw_form" data-fw-ext-forms-type="contact-forms">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-md-6 form-builder-item">
                                                                <div class="form-group has-placeholder">
                                                                    ...
                                                                    <input class="form-control" type="text" name="text_10c62e2" placeholder="First Name" value="" id="id-1" required="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12 col-md-6 form-builder-item">
                                                                <div class="form-group has-placeholder">
                                                                    <label for="id-2">Last Name <sup>*</sup> </label>
                                                                    <input class="form-control" type="text" name="text_90a8cc7" placeholder="Last Name" value="" id="id-2" required="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-md-6 form-builder-item">
                                                                <div class="form-group has-placeholder">
                                                                    ...
                                                                    <input class="form-control" type="text" name="email_28153a8" placeholder="Your E-Mail" value="" id="id-3" required="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12 col-md-6 form-builder-item">
                                                                <div class="form-group has-placeholder">
                                                                    <label for="id-4">Your Phone <sup>*</sup> </label>
                                                                    <input class="form-control" type="text" name="text_e666f51" placeholder="Your Phone" value="" id="id-4" required="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xs-12 form-builder-item">
                                                                <div class="field-select select-styled ">
                                                                    <select name="select_8121a07" id="id-5" class="form-control">
                                                                        <option value="Practice Area">Data Driven Advertising</option>
                                                                        <option value="Corporate Law">Social Media Marketing</option>
                                                                        <option value="Intellectual Property Matters">Design and Development</option>
                                                                        <option value="Litigation and Arbitration">Bulk SMS Management</option>
                                                                        ...
                                                                        <option value="Insurance(Motor, construction)">Insurance(Motor, construction)</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xs-12 form-builder-item">
                                                                <div class="form-group has-placeholder">
                                                                    ...
                                                                    <textarea class="form-control" rows="1" name="textarea_18181fd" placeholder="Your Message" id="id-6" required="required"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row"></div>
